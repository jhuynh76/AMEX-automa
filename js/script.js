...
$('#btnGenerate').click(function(e){
  var name = $('#name').val();
  var img_name = $('#img_name').val().toUpperCase();
  ...
  var img_link = '<img src="http://f.email.americanexpress.com/i/45/268935401/' + img_name + '" alt="" title="" height="auto" style="border:none;border-radius:;display:block;outline:none;text-decoration:none;width:100%;height:auto;" width="620" />';
